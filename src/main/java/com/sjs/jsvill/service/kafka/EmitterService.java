...
public class EmitterService {
    private final KafkaProdNotiService notificationsService;
    ...
    public void listen(NotiMessage message) {
        //인위적으로 폴링 간격을 늘림
        ...
        log.info("message.message.getUserId() : {}", message.getUserPhone());
...
//        }
        ...
        Map<String, SseEmitter> sseEmitters = emitterRepository.findAllEmitterStartWithById(userPhone);
